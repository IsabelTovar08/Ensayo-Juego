...
class MyScene extends Phaser.Scene {
   ...
   this.add.image(0, -500, 'fondo3').setOrigin(0,0).setScale(2);
     ...
     this.add.image(1150, config.height-95, 'caramelo-o').setScale(0.04).setOrigin(0,1);
     this.add.image(850, config.height-190, 'caramelo-o').setScale(0.04).setOrigin(0,1);
     this.add.image(270, config.height -425, 'piedra').setScale(0.05);
     this.add.image(540, config.height -246, 'dulce').setScale(0.03).setAlpha(0.8);
     this.add.image(600, config.height -108, 'chispas').setScale(0.2).setAlpha(0.9);
     this.add.image(700, config.height -240, 'piedraC').setScale(0.07).setAlpha(0.8);
     ...
     this.add.image(250, config.height -108, 'arbol-verde').setScale(0.2).setAlpha(0.9);
   ...
   //   this.add.image(750, config.height -90, 'flor').setScale(0.1);
     ...
     this.add.image(680, config.height -260, 'arbGalletas').setScale(0.1).setAlpha(0.8);
     this.add.image(880, config.height -470, 'arbusto').setScale(0.1).setAlpha(0.8);


     this.add.image(20, config.height -90, 'arbol').setScale(0.35).setAlpha(0.9);
