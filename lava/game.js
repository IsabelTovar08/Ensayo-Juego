  ...
  function create() {
    ...
    this.add.image(200, config.height - 10, 'la').setScale(0.20);
    ...
    if (window.innerWidth <= 1000) { // Ajusta el ancho según sea necesario
      ...
      const jumpButton = this.add.sprite(100, this.scale.height - 100, 'button').setInteractive().setScale(0.5);
      ...
      const rightButton = this.add.sprite(150, this.scale.height - 100, 'rightButton').setInteractive().setScale(0.5);
